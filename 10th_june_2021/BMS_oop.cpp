/*
    ...
    added object oriented programming concepts
    Encapsulation: combined data members and member functions into the class
    abstraction: data members are private. Only accessible to the member function of same class
    And member fuctions are public. 
*/
...
void book_management :: create_book(){
...
void book_management :: insert_book(){
...
void book_management :: search_by_id(){
...
void book_management :: search_by_author(){
    int flag=0;
...
void book_management :: display_list(){
...
int main(){
    ...
    do{
        ...
        cin>>ch;
        switch(ch){
            case 1 :b.create_book();
                     break;

            case 2 : b.insert_book();
                    break;
            
            case 3 : b.search();
                     break;

            case 4 : b.delete_book();
                     break;

            case 5 : b.display_list();
                     break;
